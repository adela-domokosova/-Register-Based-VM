...
public:
	...
	static void load(VM& vm, const std::vector<std::string>& args); // from RAM addres to register
	static void store(VM& vm, const std::vector<std::string>& args); // from register to RAM
